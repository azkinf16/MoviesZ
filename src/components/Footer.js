...
function Footer() {
  return (
    <>
      <footer className="text-center text-white bg-[#0F182B] mt-10">
        <div className="container pt-9">
          <div className="flex justify-center mb-9">
            <a href="#!" className="mr-9 text-slate-500 hover:text-slate-600">
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="fab"
        ...
        <div
          className="text-center text-slate-500 pb-4 mb-3"
        >
          © 2022 Copyright :
          <a className="text-slate-500 pl-1 hover:text-slate-600" href="#!">
            Azki Nurul Fajri
          </a>
        </div>
      </footer>
